      ...
      <img src={'/assets/navy_blue_id_seal.png'}/>
        ...
        <div className={section3Styles.grid}>
          ...
          <div className={section3Styles.item}>
            ...
            <div className={section3Styles.text}>Society Founder & Chair 2022/23</div>
          </div>
          ...
          <div className={section3Styles.item}>
            <div className={section3Styles.rect3} />
            <h3 className={section3Styles.subtitle1}>Dr. Ferda Ozdemir Sonmez</h3>
            <div className={section3Styles.text}>Title</div>
          </div>

          <div className={section3Styles.item}>
            <div className={section3Styles.rect3} />
            <h3 className={section3Styles.subtitle1}>Michael Suarez</h3>
            <div className={section3Styles.text}>Title</div>
          </div>

          <div className={section3Styles.item}>
            <div className={section3Styles.rect3} />
            <h3 className={section3Styles.subtitle1}>That's My Quant</h3>
            <div className={section3Styles.text}>Title</div>
          </div>
          ...
          <div className={section3Styles.item}>
            <div className={section3Styles.rect3} />
            <h3 className={section3Styles.subtitle1}>Zeno Zhuang</h3>
            <div className={section3Styles.text}>Title</div>
          </div>
          ...
          <div className={section3Styles.item}>
            <div className={section3Styles.rect3} />
            <h3 className={section3Styles.subtitle1}>Romain de Spoelberch</h3>
            <div className={section3Styles.text}>Title</div>
          </div>
